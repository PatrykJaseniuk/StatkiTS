...
import { DynamicRotationElement } from "./DynamicElement";
import { PositionRotation } from "./PositionRotation";


export class HullRotation2 {

    dynamicElemet: DynamicRotationElement;
    view: ViewTexture;
    positionRotation: PositionRotation

    constructor() {
        this.positionRotation = new PositionRotation();
        this.dynamicElemet = new DynamicRotationElement(this.positionRotation, 100, 100);
